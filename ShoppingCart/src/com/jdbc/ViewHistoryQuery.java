...
public class ViewHistoryQuery 
{
	...
	/*public ViewHistoryQuery(boolean isTrue, int OrderID, int CartID,int Price, int results,	String Address){
		this.isTrue = isTrue;
	...
	public static List<ViewHistoryQuery> getHistory(int CustID)
	{
		List<ViewHistoryQuery> vhqList = new ArrayList<ViewHistoryQuery>();
		try
		{
			...
			boolean isTrue = false;
				...
				while(rs.next())
				{
					...
					ViewHistoryQuery VHQ = new ViewHistoryQuery();
